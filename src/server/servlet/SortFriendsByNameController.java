...
public class SortFriendsByNameController extends HttpServlet {

	
	private static Logger log = Logger.getLogger(SortFriendsByNameController.class);
...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Collections.sort(sortirani, new TestComparatorFriendName());
	...
	public class TestComparatorFriendName implements Comparator<Object> {
		
	    public int compare(Object obj1, Object obj2){
	        Gost p1=(Gost) obj1;
	        Gost p2=(Gost) obj2;
	       
	        String p1name=p1.getKorisnik_ime();
	        String p2name=p2.getKorisnik_ime();
