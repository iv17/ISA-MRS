...
public class SortRestaurantsByTypeController extends HttpServlet{

	
	private static Logger log = Logger.getLogger(SortRestaurantsByTypeController.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Collections.sort(sortirani, new TestComparator2());
	...
	public class TestComparator2 implements Comparator<Object> {
	
		    public int compare(Object obj1, Object obj2){
		        Restoran p1=(Restoran) obj1;
		        Restoran p2=(Restoran) obj2;
		       
		        String p1name=p1.getTipRestoran();
		        String p2name=p2.getTipRestoran();
