...
<jsp:useBean id="dodaj_prijatelje" type="java.util.List" scope="request"/>
<html>
...
<body id="addfriends" data-target=".navbar" data-offset="50">
<c:if test="${(sessionScope.bad_time!=null)}">
		<script> toastr.error('Reservation can not be canceled. There is less 30 minutes to the arrival date.'); </script>
	</c:if>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="#addfriends" onclick="add_friends()">ADD FRIENDS</a></li>
		<li class="dropdown">
	...
	<div id="restaurant" class="bg-1">
		...
		<div class="container">
			<h3 class="text-center">ADD FRIENDS</h3>
				...
				<c:forEach var="res" items="${dodaj_prijatelje}">
					<div class="form-box">
				        ...
				        <div class="form-bottom">
							<form role="form" class="restaurant_update">
							    ...
							    <button type="submit" class="btn" onclick="window.location.href='./AddFriendController?korisnikId=${res.korisnik_id}';">Add friend</button> 
