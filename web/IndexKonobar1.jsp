  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="./rasporedStolova.jsp">TABLES</a></li>
        <li><a href="#menu">CALENDAR</a></li>
        <li><a href="#drink_cart">ORDERS</a></li>
		<li><a href="#groceries">CREATE BILL</a></li>
		<li class="dropdown">
...
<div id="my_profile" class="bg-1"><div class="container"><h3 class="text-center">PROFILE UPDATE</h3>
	<div class="form-box"><div class="form-top"><h3 class="text-center"></h3></div>
	    <div class="form-bottom">
			<form action="./UpdateKonobarController" method="post" class="profile_update">
				<div class="form-group">
			        <label class="sr-only" for="form-email-konobar">Email</label>
			        <input type="text" name="form-email-konobar" placeholder="Username" class="form-email-konobar form-control" id="form-email-konobar" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
				</div>
				<div class="form-group">
			        <label class="sr-only" for="form-password-konobar">Password</label>
			        <input type="password" name="form-password-konobar" placeholder="Password" class="form-password-konobar form-control" id="form-password-konobar" pattern=".{6,}">
			    </div>
				<!--
				<div class="form-group">
				...
				-->
			    <div class="form-group">
			        <label class="sr-only" for="form-name-konobar">Name</label>
			        <input type="text" name="form-name-konobar" placeholder="Name" class="form-name-konobar form-control" id="form-name-konobar" pattern="[A-Za-z]{4,10}">
				</div>
				<div class="form-group">
			        <label class="sr-only" for="form-lastname-konobar">Last name</label>
			        <input type="text" name="form-lastname-konobar" placeholder="Last name" class="form-lastname-konobar form-control" id="form-lastname-konobar" pattern="[A-Za-z]{4,10}">
			    </div>
				<div class="form-group">
			        <label class="sr-only" for="form-date-konobar">Date of birth</label>
			        <input type="text" name="form-date-konobar" placeholder="Date of birth(dd/mm/yyyy)" class="form-date-konobar form-control" id="form-date-konobar" pattern="\[0-9]{1,2}/\[0-9]{1,2}/\[0-9]{4}">
			    </div>
				<div class="form-group"><h5> Clothes size </h5>   
					<select name="form-konfekcijski-broj-konobar" class="form-konfekcijski-broj-konobar form-control" id="form-konfekcijski-broj-konobar">
				...
				<div class="form-group">
			        <label class="sr-only" for="form-velicina-obuce-konobar">Shoe size</label>
			        <input type="number" name="form-velicina-obuce-konobar" placeholder="Shoe size" class="form-velicina-obuce-konobar form-control" id="form-velicina-obuce-konobar" pattern="[A-Za-z]{4,10}">
			    </div>
