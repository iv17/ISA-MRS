        ...
        <div class="form-bottom">
			<table class="table dataTable table-bordered table-hover" id="ordersTable">
				...
				<c:forEach items="${narudzbine}" var="narudzbina">
					<tr>
					<td>
					<table class="table dataTable table-bordered table-hover" id="ordersTableMeals">
						<tbody>
							<c:forEach items="${narudzbina.obrok.jela}" var="jelo1">
								<td>${jelo1.nazivJela}</td>
							</c:forEach>
						</tbody>
					</table>
					</td>
...
<div id="my_profile" class="bg-1"><div class="container"><h3 class="text-center">PROFILE UPDATE</h3>
	<div class="form-box"><div class="form-top"><h3 class="text-center"></h3></div>
	    <div class="form-bottom">
			<form action="./UpdateKuvarController" method="post" class="profile_update">
				<div class="form-group">
			        <label class="sr-only" for="form-email-kuvar">Email</label>
			        <input type="text" name="form-email-kuvar" placeholder="Username" class="form-email-kuvar form-control" id="form-email-kuvar" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
				</div>
				<div class="form-group">
			        <label class="sr-only" for="form-password-kuvar">Password</label>
			        <input type="password" name="form-password-kuvar" placeholder="Password" class="form-password-kuvar form-control" id="form-password-kuvar" pattern=".{6,}">
			    </div>
				<!--
				<div class="form-group">
				...
				-->
			    <div class="form-group">
			        <label class="sr-only" for="form-name-kuvar">Name</label>
			        <input type="text" name="form-name-kuvar" placeholder="Name" class="form-name-kuvar form-control" id="form-name-kuvar" pattern="[A-Za-z]{4,10}">
				</div>
				<div class="form-group">
			        <label class="sr-only" for="form-lastname-kuvar">Last name</label>
			        <input type="text" name="form-lastname-kuvar" placeholder="Last name" class="form-lastname-kuvar form-control" id="form-lastname-kuvar" pattern="[A-Za-z]{4,10}">
			    </div>
				<div class="form-group">
			        <label class="sr-only" for="form-date-kuvar">Date of birth</label>
			        <input type="text" name="form-date-kuvar" placeholder="Date of birth(dd/mm/yyyy)" class="form-date-kuvar form-control" id="form-date-kuvar" pattern="\[0-9]{1,2}/\[0-9]{1,2}/\[0-9]{4}">
			    </div>
				<div class="form-group"><h5> Clothes size </h5>   
					<select name="form-konfekcijski-broj-kuvar" class="form-konfekcijski-broj-kuvar form-control" id="form-konfekcijski-broj-kuvar">
				...
				<div class="form-group">
			        <label class="sr-only" for="form-velicina-obuce-kuvar">Shoe size</label>
			        <input type="number" name="form-velicina-obuce-kuvar" placeholder="Shoe size" class="form-velicina-obuce-kuvar form-control" id="form-velicina-obuce-kuvar" pattern="[A-Za-z]{4,10}">
			    </div>
			    <div class="form-group">
			        <label class="sr-only" for="form-tip-kuvar">Chef type</label>
			        <input type="text" name="form-tip-kuvar" placeholder="type" class="form-tip-kuvar form-control" id="form-tip-kuvar" pattern="[A-Za-z]{4,10}">
				</div>
