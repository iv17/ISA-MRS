...
<jsp:useBean id="zahtevi" type="java.util.List" scope="request"/>
...
<c:if test="${(sessionScope.odbijen!=null)}">
		<script> toastr.success('Friendship declined.'); </script>
	</c:if>


<c:if test="${(sessionScope.prihvacen!=null)}">
		<script> toastr.success('Friendship accepted.'); </script>
	</c:if>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li class="active"><a href="#requests" onclick="view_friend_req()">FRIEND REQUESTS</a></li>
	...
	<div id="restaurant" class="bg-1">
		...
		<div class="container">
			<h3 class="text-center">FRIEND REQUESTS</h3>
				...
				<c:forEach var="res" items="${zahtevi}">
					<div class="form-box">
				        ...
				        <div class="form-bottom">
							<form role="form" class="restaurant_update">
								...
								<button type="submit" class="btn" onclick="window.location.href='./AcceptFriendController?prijateljId=${res.korisnik_id}';">Confirm</button> 
								<button type="submit" class="btn" onclick="window.location.href='./DeclineFriendController?prijateljId=${res.korisnik_id}';">Decline</button> 
