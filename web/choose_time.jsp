...
<script>function toast() {
    var toast = $(window).AndroidToast({
		message : "Time for reservation can not be empty",
		stayTime: "3000"
	});
...
<script>function toast2() {
    var toast2 = $(window).AndroidToast({
		message : "Please choose correct time",
		stayTime: "3000"
	});
    toast2.AndroidToast('show');
}
</script>

<script>function toast3() {
    var toast = $(window).AndroidToast({
		message : "Already taken. Please choose different time for reservation or another table.",
		stayTime: "3000"
	});
    toast.AndroidToast('show');
}
...
<c:if test="${(sessionScope.error_time == true)}">
		<script> toast();</script>
	</c:if>
	
<c:if test="${(sessionScope.wrong_time == true)}">
		<script> toast2();</script>
	</c:if>
	
<c:if test="${(sessionScope.zauzeto == true)}">
		<script> toast3();</script>
	</c:if>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="#chooseres" onclick="choose_restaurant()">BOOK A TABLE</a></li>
	...
	<div class="bg-1">
		...
		<div class="container">
			...
			<div class="form-top">           		
		            <h3 class="text-center">CHOOSE TIME FOR RESERVATION</h3>           		
		        </div>
				
			<div class="form-box">
				<div class="form-bottom">
					<div class="form-group">
							<button type="submit" class="btn" onclick="back_to_restaurants()">Back to restaurants</button> 
					</div>
					<div class="form-group">
						<label>Choose date and time for reservation:</label>        
					</div>
					<form action="./CheckReservationTimeController" method="post" accept-charset="ISO-8859-1">
						<div class="form-group">
							<input type="text" name="datumrez" value="" readonly>
							<script type="text/javascript">
								$(function(){
									$('*[name=datumrez]').appendDtpicker({
						...
						<div class="form-group">
							<label>Reservation lasts until:</label>        
						</div>
						<div class="form-group">
							<input type="text" name="vremerez" value="" readonly>
							<script type="text/javascript">
								$(function(){
									$('*[name=vremerez]').timepicker({
						...
						<div class="form-group">
							<button type="submit" class="btn" value="./CheckReservationTimeController">Next</button> 
						</div>
						</form>
...
function choose_table() {
    window.location.href = "./CheckReservationTimeController";
}
