...
<jsp:useBean id="moje_narudzbine" type="java.util.List" scope="request"/>
...
<c:if test="${(sessionScope.order_can1!=null)}">
		<script> toastr.error('Order can not be canceled. There is less than 30 minute to reservation.'); </script>
	</c:if>
	
<c:if test="${(sessionScope.cancel_order1!=null)}">
		<script> toastr.success('Order canceled.'); </script>
	</c:if>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="#" onclick="show_orders()">ORDERS</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div id="restaurant" class="bg-1">
		...
		<div class="container">
			...
			<c:forEach var="res" items="${moje_narudzbine}">
				<div class="form-box">
						...
						<form role="form" class="restaurant_update">
							...
							<c:forEach var="p" items="${res.porucenoPice.pica}">
						    	...
						    	<div class="form-group">
						        	...
						        	<input type="text" name="form-type" value = "${p.cenaPica}" class="form-type form-control" id="form-type"  disabled="disabled">
						    	</div>
							</c:forEach>
							...
							<c:forEach var="j" items="${res.obrok.jela}">
						    	...
						    	<div class="form-group">
						        	...
						        	<input type="text" name="form-type" value = "${j.cenaJela}" class="form-type form-control" id="form-type"  disabled="disabled">
						    	</div>
							</c:forEach>
						    
						</form>
							
							<button class = "btn btn-primary btn-lg" data-toggle = "modal" data-target = "#myModal">Cancel order</button>
					   ...
					   <div class = "modal-dialog">
					      <div class = "modal-content">
					         ...
					         <div class = "modal-footer">
					            ...
					            <button type = "button" class = "btn btn-primary" onclick="window.location.href='./CancelOrderController?narId=${res.idNarudzbine}';">
					               Yes
					            </button>
					         </div>
