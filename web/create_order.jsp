...
<jsp:useBean id="ponudjena_jela" type="java.util.List" scope="session"/>
<jsp:useBean id="ponudjena_pica" type="java.util.List" scope="session"/>
...
<c:if test="${(sessionScope.fr!=null)}">
		<script> toastr.success('Friend request sent.'); </script>
	</c:if>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div id="restaurant" class="bg-1">
		...
		<div class="container">
			...
			<h3 class="text-center">Choose food:</h3>  
			<c:forEach var="res" items="${ponudjena_jela}">
				<div class="form-box">
					
			        <div class="form-bottom">
						<form role="form" class="restaurant_update">
						    <div class="form-group">
						        <input type="text" value = "${res.nazivJela}" name="form-name" class="form-name form-control" id="form-name"  disabled="disabled">
						    </div>
						    <div class="form-group">
	
						        <input type="text" name="form-type" value = "${res.tipJela}" class="form-type form-control" id="form-type"  disabled="disabled">
						    </div>
							<div class="form-group">
	
						        <input type="text" name="form-type" value = "${res.opisJela}" class="form-type form-control" id="form-type"  disabled="disabled">
						    </div>
							<div class="form-group">
	
						        <input type="text" name="form-type" value = "${res.cenaJela}" class="form-type form-control" id="form-type"  disabled="disabled">
						    </div>
							
  							 
													    
						</form>
							<button class = "btn btn-primary btn-lg" onclick="window.location.href='./AddFoodToOrderController?jeloId=${res.idJela}';">Add to order</button>
			...
			<h3 class="text-center">Choose drink:</h3>  
			<c:forEach var="res" items="${ponudjena_pica}">
				<div class="form-box">
					
			        <div class="form-bottom">
						<form role="form" class="restaurant_update">
							<div class="form-group">
							         <input type="text" value = "${res.nazivPica}" name="form-name" class="form-name form-control" id="form-name"  disabled="disabled">
						 				   
							    </div>
							
						    <div class="form-group">
						        <input type="text" value = "${res.tipPica}" name="form-name" class="form-name form-control" id="form-name"  disabled="disabled">
						    </div>
						    <div class="form-group">
	
						        <input type="text" name="form-type" value = "${res.opisPica}" class="form-type form-control" id="form-type"  disabled="disabled">
						    </div>
							<div class="form-group">
	
						        <input type="text" name="form-type" value = "${res.cenaPica}" class="form-type form-control" id="form-type"  disabled="disabled">
						    </div>
						   
							
						</form>
						<button class = "btn btn-primary btn-lg" onclick="window.location.href='./AddDrinkToOrderController?piceId=${res.idPica}';">Add to order</button>
