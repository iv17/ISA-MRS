...
<div id="create_new_supply" class="bg-1"><div class="container"><h3 class="text-center">CREATE NEW SUPPLY</h3>
	<div class="form-box"><div class="form-top"><h3 class="text-center">CREATE NEW SUPPLY</h3></div>
	    <div class="form-bottom">
			<form action="./CreatePonudaController" method="post" class="supply_update">
				<div class="form-group">
			        <label class="sr-only" for="form-price">Price</label>
			        <input type="text" name="form-price" placeholder="Price" class="form-price form-control" >
			    </div>
				<div class="form-group">
