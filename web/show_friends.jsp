...
<jsp:useBean id="prijatelji" type="java.util.List" scope="request"/>
<html>
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="active"><a href="#friends" onclick="view_friends()">Friends</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div id="restaurant" class="bg-1">
		<button type="submit" class="btn" onclick="sortByName()">Sort by first name</button> 
		<button type="submit" class="btn" onclick="sortByLname()">Sort by last name</button> 
			
		
		<div class="container">
			<h3 class="text-center">FRIENDS</h3>
			<form action="./SearchFriendsController" method="post" accept-charset="ISO-8859-1">
	
				<input type= "text" value="search friends"   onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'search friends';}" class="form-name form-control" name="search_fr" id="search_fr" style="width: 300px;">				
				<button type="submit" class="btn" value="./SearchFriendsController">Search</button> 
			</form>
			
				<c:forEach var="res" items="${prijatelji}">
					<div class="form-box">
				        ...
				        <div class="form-bottom">
							<form role="form" class="restaurant_update">
								...
								<button class = "btn btn-primary btn-lg" data-toggle = "modal" data-target = "#myModal">Remove friend</button>
						</div>
					</div>
					   ...
					   <div class = "modal-dialog">
					      <div class = "modal-content">
					         ...
					         <div class = "modal-footer">
					            ...
					            <button type = "button" class = "btn btn-primary" onclick="window.location.href='./RemoveFriendController?prijateljId=${res.korisnik_id}';">
					               Remove
					            </button>
					         </div>
