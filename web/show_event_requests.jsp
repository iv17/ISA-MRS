...
<jsp:useBean id="pozivnice" type="java.util.List" scope="request"/>
...
<body id="requests" data-target=".navbar" data-offset="50">
<c:if test="${(sessionScope.odbijen_event!=null)}">
		<script> toastr.success('Invitation declined.'); </script>
	</c:if>


<c:if test="${(sessionScope.prihvacen_event!=null)}">
		<script> toastr.success('Invitation accepted.'); </script>
	</c:if>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="#requests" onclick="view_friend_req()">FRIEND REQUESTS</a></li>
            <li class="active"><a href="#friendr">EVENT REQUESTS</a></li>
          </ul>
        </li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div id="restaurant" class="bg-1">
		...
		<div class="container">
			<h3 class="text-center">EVENT REQUESTS</h3>
			
				<c:forEach var="res" items="${pozivnice}">
					<div class="form-box">
				        ...
				        <div class="form-bottom">
							<form role="form" class="restaurant_update">
							    ...
							    <div class="form-group">
									 <input type="text" value = "${res.datumDolaskaRezervacija}" name="form-name" class="form-name form-control" id="form-name"  disabled="disabled">
							    	
							    </div>
							    
							    <div class="form-group">
									 <input type="text" value = "${res.rezervacija_duzina_boravka}" name="form-name" class="form-name form-control" id="form-name"  disabled="disabled">
							    	
							    </div>
								
							</form>
								<button type="submit" class="btn" onclick="window.location.href='./AcceptEventController?eventId=${res.idRezervacija}';">Confirm</button> 
								<button type="submit" class="btn" onclick="window.location.href='./DeclineEventController?eventId=${res.idRezervacija}';">Decline</button> 
