...
<jsp:useBean id="moje_rezervacije" type="java.util.List" scope="request"/>
<jsp:useBean id="rezervacije_pozvani" type="java.util.List" scope="request"/>
...
<c:if test="${(sessionScope.bad_time1!=null)}">
		<script> toastr.error('Reservation can not be canceled. There is less than 30 minute to reservation.'); </script>
	</c:if>
	
<c:if test="${(sessionScope.cancel_res1!=null)}">
		<script> toastr.success('Reservation canceled.'); </script>
	</c:if>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="#" onclick="show_reservations()">RESERVATIONS</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div id="restaurant" class="bg-1">
		...
		<div class="container">
			...
			<c:forEach var="res" items="${moje_rezervacije}">
				<div class="form-box">
			        ...
			        <div class="form-bottom">
						<form role="form" class="restaurant_update">
						    ...
						    <div class="form-group">
						        ...
						        <input type="text" name="form-type" value = "${res.datumDolaskaRezervacija}" class="form-type form-control" id="form-type"  disabled="disabled">
						    </div>
							<div class="form-group">
	
						        <input type="text" name="form-type" value = "${res.rezervacija_duzina_boravka}" class="form-type form-control" id="form-type"  disabled="disabled">
						    </div>
							<label>Coming:</label>
									<c:forEach var="p" items="${res.prihvaceniGosti}">
										
										<div class="form-group">
			
								        	<input type="text" name="form-type" value = "${p.korisnik_ime}" class="form-type form-control" id="form-type"  disabled="disabled">
								    		<input type="text" name="form-type" value = "${p.korisnik_prezime}" class="form-type form-control" id="form-type"  disabled="disabled">
							...
							<button class = "btn btn-primary btn-lg" onclick="window.location.href='./CreateOrderController?rezId=${res.idRezervacija}';">Create order</button>
					
							<button class = "btn btn-primary btn-lg" data-toggle = "modal" data-target = "#myModal">Cancel reservation</button>
					   ...
					   <div class = "modal-dialog">
					      <div class = "modal-content">
					         ...
					         <div class = "modal-footer">
					            ...
					            <button type = "button" class = "btn btn-primary" onclick="window.location.href='./CancelReservationController?resId=${res.idRezervacija}';">
					               Yes
					            </button>
					         </div>
			...
			<c:forEach var="res" items="${rezervacije_pozvani}">
				<div class="form-box">
			        ...
			        <div class="form-bottom">
						<form role="form" class="restaurant_update">
							<div class="form-group">
							        <label>From:</label>
							        <input type="text" value = "${res.gost.korisnik_ime}" name="form-name" class="form-name form-control" id="form-name"  disabled="disabled">
							    	<input type="text" value = "${res.gost.korisnik_prezime}" name="form-name" class="form-name form-control" id="form-name"  disabled="disabled">
						...
						<button class = "btn btn-primary btn-lg" data-toggle = "modal" data-target = "#myModal1">Cancel invitation</button>
					   ...
					   <div class = "modal-dialog">
					      <div class = "modal-content">
					         ...
					         <div class = "modal-footer">
					            ...
					            <button type = "button" class = "btn btn-primary" onclick="window.location.href='./CancelInvitationController?resId=${res.idRezervacija}';">
					               Yes
					            </button>
					         </div>
